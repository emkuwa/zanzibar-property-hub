  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          Zanzibar Property Investment Opportunities
        </motion.h1>
        ...
        >
          Discover high-potential villas, beachfront developments, and tourism property investments in Zanzibar — one of Africa’s fastest growing destinations for international investors.
        </motion.p>

        <p className="mt-3 text-sm text-primary-foreground/70">
          Explore curated property investment opportunities in Zanzibar.
        </p>
