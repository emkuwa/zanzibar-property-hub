      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="mt-4 text-primary-foreground/75 text-lg max-w-xl mx-auto">
            Estimate your potential returns from a Zanzibar property investment.
          </p>
        </motion.div>
        ...
        >
          <div className="grid md:grid-cols-3 gap-8 mb-10">
            <div>
              <label className="block text-sm font-semibold text-muted-foreground mb-2">Property Price ($)</label>
              <input
                type="number"
                value={price}
                onChange={(e) => setPrice(Number(e.target.value))}
                className="w-full rounded-lg border border-input bg-background px-4 py-3 text-foreground font-semibold focus:outline-none focus:ring-2 focus:ring-ring"
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-muted-foreground mb-2">Nightly Rental ($)</label>
              <input
                type="number"
                value={nightly}
            ...
            <div>
              <label className="block text-sm font-semibold text-muted-foreground mb-2">Occupancy Rate (%)</label>
              <input
                type="number"
                value={occupancy}
